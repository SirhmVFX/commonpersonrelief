    ...
    <>
      <div className="md:w-5/6 mx-auto p-4 pt-20 md:py-16 lg:py-32 flex flex-col items-center gap-8">
        <div className="w-full h-[300px] md:h-[400px] mb-8 md:mb-0 relative ">
          ...
          <h1 className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white md:text-xl lg:text-3xl w-3/4 text-center font-medium">
            <span className="font-bold text-primarycolor">
              At the moment we do not have any sponsors or partners
            </span>{" "}
            but we are opened to collaborate with dedicated partners who share
            the same vision and mission. Join us in making a lasting impact in
            communities across the globe.
          </h1>
        </div>

        <h1 className=" border rounded-full p-2 md:text-xl lg:text-xl text-primarycolor text-center">
          A few reasons why you should collaborate with us
        </h1>
          ...
          <div className="flex items-start gap-4 p-3 md:p-4 border border-gray-200">
            ...
            <div className="flex flex-col gap-1 md:gap-2">
              ...
              <p className="text-gray-500 text-xs md:text-sm">
                ...
                organizations and individuals committed to creating a better,
                more inclusive world. Together, we can achieve more.
              </p>
            </div>
          </div>
      ...
      <div className=" md:w-5/6 mx-auto p-4 md:h-[50vh] justify-center  flex flex-col items-center mb-8 md:mb-0 pt-12 md:pt-0">
