    ...
    <>
      ...
      <div className="w-5/6 mx-auto pt-20">
        <div className="flex gap-4 pb-20">
          <div className="w-1/2">
            <h1 className="text-7xl font-medium">Our Programs</h1>
          </div>
      ...
      <div className="bg-gray-100 p-20 flex gap-4 items-end">
      ...
      <div className="w-5/6 mx-auto py-20 flex flex-col gap-4">
        <div className="flex flex-col gap-4 items-center">
          <h1 className="text-7xl font-medium">Our Approach Trustworthiness</h1>
          <p className="text-gray-500">
