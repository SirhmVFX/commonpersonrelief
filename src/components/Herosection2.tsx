...
const Herosection2 = () => {
    return (
        <div className="h-screen relative">
            ...
            <Image src={"https://res.cloudinary.com/dkeh0cumc/image/upload/v1748879242/whero_jp2teh.png"} width={10000} height={10000} alt="img" className="w-full h-full object-cover absolute" />
