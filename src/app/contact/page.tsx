...
export default function Contact() {
  return <div>
    ...
    <div className="md:w-5/6 mx-auto py-16 flex md:flex-row flex-col items-center gap-4">
      <div className="w-full flex md:flex-row flex-col gap-8 p-6 md:p-16 bg-gray-50 rounded-lg">
        ...
        <div className="md:w-2/5 md:p-10 p-4 bg-white flex flex-col gap-8 rounded-2xl">
          ...
          <div className="flex flex-col gap-2 items-start">
            ...
            <button className="bg-primarycolor text-white p-2 rounded-md">+1 (432) 803-1218</button>
          </div>
          </div>
        </div>
      </div>
