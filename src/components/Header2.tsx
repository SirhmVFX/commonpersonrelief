  ...
  return (
    <>
      ...
      >
        <div className="mx-auto w-5/6 flex justify-between items-center py-6">
          ...
          <div className="hidden lg:flex gap-10 items-center">
            <div>
              <Link
                className={`text-white flex items-center ${showWhoDropdown ||
                    showServeDropdown ||
                    showGiveDropdown ||
                    isMobileMenuOpen ||
                    pathname !== "/" ||
      ...
      <div className="hidden lg:block">
        <div
          className={`fixed top-[72px] left-0 right-0 bg-white backdrop-blur-md py-8 transition-all duration-300 z-40 ${
          ...
          <div className="mx-auto w-5/6">
            <div className="grid grid-cols-3 gap-4">
              ...
              >
                ...
                <div>
                  <h1 className="text-2xl text-black/80 font-bold">About us</h1>
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                  Join our mission by contributing your time, skills, or expertise.
                  </p>
                </div>
              </Link>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                  Collaborate as an organization, donor, or community leader.
                  </p>
                </div>
              </Link>
              <Link
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                  Your contribution makes a difference. Support a cause today.
                  </p>
                </div>
              </Link>
